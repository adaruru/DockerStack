...
![image-20250121101831751](.attach/.README/image-20250121101831751.png)

新增連線

![image-20250121101954323](.attach/.README/image-20250121101954323.png)

選擇 v2 

![image-20250121102051463](.attach/.README/image-20250121102051463.png)

port 使用 container 對外 port

![image-20250121102732098](.attach/.README/image-20250121102732098.png)

沒有設置 username 與 passeword 就跳過

![image-20250121102804792](.attach/.README/image-20250121102804792.png)

![image-20250121102814814](.attach/.README/image-20250121102814814.png)

連上就可以看已經push 的 image

![image-20250121103154624](.attach/.README/image-20250121103154624.png)
...
![image-20250106140617970](.attach/.README/image-20250106140617970.png)
...
![image-20241224161111074](.attach/.README/image-20241224161111074.png)
...
![image-20241224163723167](.attach/.README/image-20241224163723167.png)

確保目錄中包含 `docker-compose.yml`

compose up 之後新增了一個 .verdaccio-db.json

![image-20241224173809899](.attach/.README/image-20241224173809899.png)
